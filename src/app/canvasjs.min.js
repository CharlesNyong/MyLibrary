...
(function() {
    ...
    function V(k, m, v, s, w) {
        ...
        s.push([k, m, v, w]);
        return k.addEventListener ? (k.addEventListener(m, v, w),
        v) : k.attachEvent ? (s = function(m) {
            m = m || window.event;
    ...
    function Qa(k, m, v, t, s) {
        ...
        "undefined" !== typeof t && (k = Math.min(t, k),
        "undefined" !== typeof s && (k = Math.max(s, k)));
    ...
    function W(k, m, v, s, w) {
        ...
        k = {};
        this.theme && t(this.parent) && t(m) && t(s) ? k = t(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === s ? k = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (s = Math.min(this.parent.themeOptions[m].length - 1, s),
    ...
    function xa(k, m) {
        ...
        if (t(this.options.margin) && k.options.subtitles)
            for (var v = k.options.subtitles, s = 0; s < v.length; s++)
                if ((t(v[s].horizontalAlign) && "center" === this.horizontalAlign || v[s].horizontalAlign === this.horizontalAlign) && (t(v[s].verticalAlign) && "top" === this.verticalAlign || v[s].verticalAlign === this.verticalAlign) && !v[s].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    var Fa = !1, J = {}, s = !!document.createElement("canvas").getContext, pa = {
        ...
        en: {}
    }, w = s ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Da = s ? "Impact, Charcoal, sans-serif" : "Arial", ya = {
    ...
    var eb = function() {
      ...
      , ea = function(k, m, v) {
        ...
        W = 0 === k ? 0 : 0 === m ? -(P + F) : String(m).length - P,
        D /= Math.pow(10, W));
        0 > N && (N = L);
        D = (k * D).toFixed(J);
        m = D.split(".");
        ...
        for (Q = F = L = J = N = 0; 0 < M.length; )
            ...
            "#" === m || "0" === m)
                ...
                N === P) {
                    ...
                    J++,
                    Q++),
                    0 === Q % F && (L === V && 0 < D.length) && (v = w + v);
            else
                "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++,
                F = Q,
                Q = 0,
                0 < D.length && (v = w + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
        ...
        for (M = !1; 0 < I.length; )
            m = I.shift(),
            "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(),
            M = !0) : "0" === m && (w += "0",
            M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
      ...
      , ca = function(k, m, v, t, s, w, D, F, N, M, Q, P, I) {
        ...
        k.strokeStyle = F,
        k.moveTo(m, v),
        k.rect(m - I, v - I, t - m + 2 * I, s - v + 2 * I),
        k.stroke());
        k.restore();
        !0 === N && (k.save(),
        k.beginPath(),
        ...
        k.lineTo(t, v),
        k.closePath(),
        D = k.createLinearGradient((t + m) / 2, v + J, (t + m) / 2, v),
        D.addColorStop(0, w),
        ...
        k.lineTo(t, s),
        k.closePath(),
        D = k.createLinearGradient((t + m) / 2, s - J, (t + m) / 2, s),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        k.fillStyle = D,
        k.fill(),
        ...
        k.lineTo(m, s),
        k.closePath(),
        D = k.createLinearGradient(m + J, (s + v) / 2, m, (s + v) / 2),
        D.addColorStop(0, w),
        ...
        k.lineTo(t - J, s - J),
        k.lineTo(t, s),
        D = k.createLinearGradient(t - J, (s + v) / 2, t, (s + v) / 2),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        k.fillStyle = D,
        D.addColorStop(0, w),
      ...
      , Y = function(k) {
        for (var m = "", t = 0; t < k.length; t++)
            m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(t));
        return m
    }
    ...
    W.prototype.setOptions = function(k, m) {
        if (pa[this._defaultsKey]) {
            ...
            for (s in t)
                "publicProperties" !== s && t.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : t[s])
        } else
    ...
    W.prototype.set = function(k, m, t) {
        ...
        else if (s.hasOwnProperty(k) || s.publicProperties && s.publicProperties.hasOwnProperty(k) && "readWrite" === s.publicProperties[k])
            this.options._isPlaceholder && this.createUserOptions(),
            this.options[k] = m;
        else {
            window.console && (s.publicProperties && s.publicProperties.hasOwnProperty(k) && "readOnly" === s.publicProperties[k] ? window.console.log('Property "' + k + '" is read-only.') : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."));
            return
        }
    ...
    W.prototype.addTo = function(k, m, t, s) {
        ...
        k = this.options[k],
        t = "undefined" === typeof t || null === t ? k.length : t,
        k.splice(t, 0, m),
        s && (this.stockChart || this.chart || this).render()) : window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readOnly" === w.publicProperties[k] ? window.console.log('Property "' + k + '" is read-only.') : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."))
    }
    ;
    W.prototype.createUserOptions = function(k) {
        if ("undefined" !== typeof k || this.options._isPlaceholder)
            ...
            this.isOptionsInArray) {
                ...
                t = m.indexOf(this.options));
                this.options = "undefined" === typeof k ? {} : k;
                m[t] = this.options
            } else
                this.options = "undefined" === typeof k ? {} : k,
                k = this.parent.options,
                this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (t = m.charAt(0).toLowerCase(),
                1 < m.length && (t = t.concat(m.slice(1))),
                m = t) : m = void 0,
                k[m] = this.options
    }
    ;
    ...
    W.prototype.removeEventListener = function(k, m) {
        if (k && m && this._eventListeners[k])
            for (var t = this._eventListeners[k], s = 0; s < t.length; s++)
                if (t[s].eventHandler === m) {
                    t[s].splice(s, 1);
                    break
                }
    }
    ...
    ia.prototype._initialize = function() {
        t(this.padding) || "object" !== typeof this.padding ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = t(this.padding.top) ? 0 : Number(this.padding.top) | 0,
        this.rightPadding = t(this.padding.right) ? 0 : Number(this.padding.right) | 0,
        this.bottomPadding = t(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0,
        this.leftPadding = t(this.padding.left) ? 0 : Number(this.padding.left) | 0)
    }
    ;
    ...
    ia.prototype._getLineWithWidth = function(k, m, t) {
        ...
        t > m && 1 < D.length && (D = D.substr(0, D.length - 1),
        t = this.ctx.measureText(D).width);
        m = !0;
    ...
    xa.prototype.setLayout = function() {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = k.layoutManager.getFreeSpace(), s = m.x1, w = m.y1, F = 0, J = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, I;
            ...
            J = 0.5 * m.height - 4));
            var M;
            t(this.padding) || "number" !== typeof this.padding ? t(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = m.y1 + 2,
            I = "top") : "bottom" === this.verticalAlign && (w = m.y2 - 2 - M.height,
            I = "bottom"),
            "left" === this.horizontalAlign ? s = m.x1 + 2 : "center" === this.horizontalAlign ? s = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (s = m.x2 - 2 - M.width - D),
            N = this.horizontalAlign,
            this.width = M.width,
            this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (s = m.x1 + 2,
            w = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2),
            F = -90,
            I = "left",
            this.width = M.height,
            this.height = M.width) : "right" === this.horizontalAlign ? (s = m.x2 - 2,
            w = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2),
            F = 90,
            I = "right",
            this.width = M.height,
            this.height = M.width) : "center" === this.horizontalAlign && (w = k.y1 + (k.height / 2 - M.height / 2),
            s = k.x1 + (k.width / 2 - M.width / 2),
            I = "center",
            this.width = M.width,
    ...
    w = Na.Chart = function() {
        ...
        function m(a, d, c) {
            ...
            s ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d),
        ...
        function D(a, d, c, b, e, f) {
            ...
            t(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2",
            t(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}),
            ...
            t(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}),
            this.sessionVariables = this.chart.sessionVariables.axisY[b]) : (this.optionsName = "axisY2",
            t(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}),
        ...
        function U(a, d, c, b, e, f) {
            ...
            !t(this.endValue) && this.endValue.getTime && (this.endValue = this.endValue.getTime());
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    ...
                    !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        ...
                        "error" === b.type && (b.linkedDataSeriesIndex = t(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex,
        ...
        m.prototype.setLayout = function() {
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    s ? (this._breaksCanvas = sa(this.width, this.height, !0),
                    ...
                    for (A = 0; A < l.dataPoints.length; A++) {
                        ...
                        if (0 < A) {
                            if (a.axisX.logarithmic) {
                                ...
                                z = b - l.dataPoints[A - 1].x,
                                0 > z && (z *= -1),
                                c.minDiff > z && 0 !== z && (c.minDiff = z);
                            null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (z = e / l.dataPoints[A - 1].y,
                            1 > z && (z = 1 / z),
                            d.minDiff > z && 1 !== z && (d.minDiff = z)) : (z = e - l.dataPoints[A - 1].y,
                            0 > z && (z *= -1),
                            d.minDiff > z && 0 !== z && (d.minDiff = z)))
                        }
                        if (b < q && !h)
                            null !== e && (r = b);
                        else {
        ...
        m.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    for (r = 0; r < n.dataPoints.length; r++) {
                        ...
                        if (0 < r) {
                            if (a.axisX.logarithmic) {
                                ...
                                u = b - n.dataPoints[r - 1].x,
                                0 > u && (u *= -1),
                                c.minDiff > u && 0 !== u && (c.minDiff = u);
                            t(e) || null === n.dataPoints[r - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / n.dataPoints[r - 1].y,
                            1 > u && (u = 1 / u),
                            d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - n.dataPoints[r - 1].y,
                            0 > u && (u *= -1),
                        ...
                        if (b < k && !q)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && z < b && (c.viewPortMin = z) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            0 <= e ? p = !0 : 0 > e && (l = !0),
                ...
                a.axisY.logarithmic ? (d.max = t(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
                d.min = t(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && !l ? (d.max = t(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = t(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && l ? (d.max = t(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = t(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !p && l && (d.max = t(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
                d.min = t(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = A
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    for (n = 0; n < h.dataPoints.length; n++) {
                        ...
                        f < d.min && (d.min = f);
                        p > d.max && (d.max = p);
                        0 < n && (a.axisX.logarithmic ? (z = b / h.dataPoints[n - 1].x,
                        1 > z && (z = 1 / z),
                        c.minDiff > z && 1 !== z && (c.minDiff = z)) : (z = b - h.dataPoints[n - 1].x,
                        0 > z && (z *= -1),
                        c.minDiff > z && 0 !== z && (c.minDiff = z)),
                        e && (null !== e[0] && h.dataPoints[n - 1].y && null !== h.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (z = e[0] / h.dataPoints[n - 1].y[0],
                        1 > z && (z = 1 / z),
                        d.minDiff > z && 1 !== z && (d.minDiff = z)) : (z = e[0] - h.dataPoints[n - 1].y[0],
                        0 > z && (z *= -1),
                        d.minDiff > z && 0 !== z && (d.minDiff = z))));
                        if (!(b < m) || r) {
                            if (!r && (r = !0,
                                    ...
                                    c) {
                                        ...
                                        if ((g = "waterfall" === a.type ? k.dataPointEOs[r].cumulativeSum : k.dataPoints[r].y) && g.length)
                                            for (var s = 0; s < g.length; s++)
                                                q = Math.floor((g[s] - l) / m),
                                                g[s] < d[q].min && (d[q].min = g[s]),
                                                g[s] > d[q].max && (d[q].max = g[s]);
                                        else
                                            t(g) || (q = Math.floor((g - l) / m),
                                            g < d[q].min && (d[q].min = g),
                                            g > d[q].max && (d[q].max = g))
                                    }
                        }
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (c = 0; c < d.length; c++)
                            ...
                            !t(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < f || "click" === e)
        ...
        m.prototype._mouseEventHandler = function(a) {
            ...
            b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && s || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
            ...
            for (p = 0; p < h.length; p++) {
                ...
                if (q > g)
                    var z = g
                      ...
                      , q = z;
                if (r.scaleBreaks)
                    for (z = 0; !f && z < r.scaleBreaks._appliedBreaks.length; z++)
                        f = r.scaleBreaks._appliedBreaks[z].startValue <= q && r.scaleBreaks._appliedBreaks[z].endValue >= g;
                if (isFinite(r.dataInfo.minDiff))
                    if (z = r.getApparentDifference(q, g, null, !0),
                    !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && z < Math.pow(r.dataInfo.minDiff, 3) || !r.logarithmic && z < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum))
                        A.push(r),
                        n.push({
                            val1: q,
                            val2: g
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var p = la("indexLabelFontWeight", h.dataPoint, h.dataSeries)
                  ...
                  , m = t(h.dataPoint.indexLabelLineThickness) ? t(h.dataSeries.options.indexLabelLineThickness) ? 0 : h.dataSeries.options.indexLabelLineThickness : h.dataPoint.indexLabelLineThickness
                ...
                if (null !== E && "" !== E) {
                    ...
                    if ("stackedarea100" === n) {
                        ...
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum)
                            continue
                    } else if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.dataPoint.y < y.viewportMinimum || h.dataPoint.y > y.viewportMaximum)
                            continue
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== u ? (e = c.y1,
                        f = c.y2,
                        0 < C ? (q = h.point.y - A - p - b,
                        q < e && (q = "auto" === u ? Math.max(h.point.y, e) + p + b : e + p + b,
                        v = q + A > h.point.y)) : (q = h.point.y + p + b,
                        q > f - A - p - b && (q = "auto" === u ? Math.min(h.point.y, f) - A - p - b : f - A - p - b,
                        v = q < h.point.y))) : (e = Math.max(h.bounds.y1, c.y1),
                        f = Math.min(h.bounds.y2, c.y2),
                        b = 0 <= n.indexOf("range") || "error" === n ? 0 < C ? Math.max(h.bounds.y1, c.y1) + A / 2 + p : Math.min(h.bounds.y2, c.y2) - A / 2 - p : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2,
                        0 < C ? (q = Math.max(h.point.y, b) - A / 2,
                        ...
                        e = 4) : 0 <= n.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === n && (u = "inside"),
                        q = h.point.y - A / 2,
                        "inside" !== u ? (p = c.x1,
                        f = c.x2,
                        0 > C ? (r = h.point.x - l - e - b,
                        r < p && (r = "auto" === u ? Math.max(h.point.x, p) + e + b : p + e + b,
                        v = r + l > h.point.x)) : (r = h.point.x + e + b,
                        r > f - l - e - b && (r = "auto" === u ? Math.min(h.point.x, f) - l - e - b : f - l - e - b,
                        v = r < h.point.x))) : (p = Math.max(h.bounds.x1, c.x1),
                        Math.min(h.bounds.x2, c.x2),
                        b = 0 <= n.indexOf("range") || "error" === n ? 0 > C ? Math.max(h.bounds.x1, c.x1) + l / 2 + e : Math.min(h.bounds.x2, c.x2) - l / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2,
                        r = 0 > C ? Math.max(h.point.x, b) - l / 2 : Math.min(h.point.x, b) - l / 2,
                        r = Math.max(r, p));
                    "vertical" === x && (q += A);
                    g.x = r;
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== u && (0 > n.indexOf("bar") && ("error" !== n || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !v) && (0 > n.indexOf("column") && ("error" !== n || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !v)) && (d.lineWidth = m,
                    d.strokeStyle = k ? k : "gray",
                    d.setLineDash && d.setLineDash(N(z, m)),
                    d.beginPath(),
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                ...
                g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries),
                h.dataSeries.indexLabelBackgroundColor = t(g) ? s ? "transparent" : null : g;
            return d
        }
        ;
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        for (var C = !1, u = 0; u < n.length; u++)
                            if (x = n[u].x.getTime ? n[u].x.getTime() : n[u].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof n[u].y)
                                    0 < u && !(h.connectNullData || C || m) && (c.stroke(),
                                    s && b.stroke()),
                                    C = !0;
                                else {
                                    ...
                                    m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(p.x, p.y),
                                    r = h.nullDataLineDashType,
                                    c.setLineDash(q)),
                                    c.lineTo(x, t),
                                    s && b.lineTo(x, t)) : (c.beginPath(),
                                    c.moveTo(x, t),
                                    s && (b.beginPath(),
                                    b.moveTo(x, t))),
                                    C = m = !1) : (c.lineTo(x, t),
                                    ...
                                    u < n.length - 1 && (k !== (n[u].lineColor || z) || r !== (n[u].lineDashType || h.lineDashType)) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(x, t),
                                    k = n[u].lineColor || z,
                                    c.strokeStyle = k,
                                    c.setLineDash && (n[u].lineDashType ? (r = n[u].lineDashType,
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        for (var C = !1, u = 0; u < n.length; u++)
                            if (x = n[u].getTime ? n[u].x.getTime() : n[u].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof n[u].y)
                                    0 < u && !(h.connectNullData || C || m) && (c.stroke(),
                                    s && b.stroke()),
                                    ...
                                    c.setLineDash(g))));
                                    if (0 < n[u].markerSize || 0 < h.markerSize)
                                        B = h.getMarkerProperties(u, x, t, c),
                                        f.push(B),
                                        y = P(y),
                                        s && f.push({
                                            x: x,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length)
                        for (x = !1,
                        m = 0; m < n.length; m++)
                            if (u = n[m].getTime ? n[m].x.getTime() : n[m].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof n[m].y)
                                    0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < t.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = q,
                                    r = h.nullDataLineDashType) : (d(t),
                                    t = [])),
                                    x = !0;
                                else {
                                    ...
                                    m < n.length - 1 && (k !== (n[m].lineColor || z) || r !== (n[m].lineDashType || h.lineDashType)) && (k = n[m].lineColor || z,
                                    t[t.length - 1].newStrokeStyle = k,
                                    b.setLineDash && (n[m].lineDashType ? (r = n[m].lineDashType,
                                    t[t.length - 1].newLineDashArray = N(r, h.lineThickness)) : (r = h.lineDashType,
                ...
                X.drawMarkers(p);
                s && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n]
                      ...
                      , z = g.dataPoints;
                    if (0 < z.length)
                        for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < z.length; f++)
                            if (z[f].getTime ? A = z[f].x.getTime() : A = z[f].x,
                            !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof z[f].y) {
                                ...
                                ca(c, p, l, m, u, b, 0, null, k && 0 <= z[f].y, 0 > z[f].y && k, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                (z[f].indexLabel || g.indexLabel || z[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    point: {
                                        x: p + (m - p) / 2,
                                        y: 0 > z[f].y === a.axisY.reversed ? l : u
                                    },
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++)
                            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x,
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y)
                                    ...
                                    f[b] = r);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y)
                                    A[b] = u[h].y + (A[b] ? A[b] : 0),
                                    B = a.axisY.convertValueToPixel(A[b]),
                                    r = "undefined" !== typeof p[b] ? p[b] : q,
                                    p[b] = B;
                                else if (r = a.axisY.convertValueToPixel(u[h].y),
                                0 <= u[h].y) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var k = a.dataSeriesIndexes[z]
                      ...
                      , u = m.dataPoints;
                    if (0 < u.length)
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < u.length; h++)
                            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x,
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                n = a.axisX.convertValueToPixel(b);
                                ...
                                0 <= u[h].y) {
                                    ...
                                    y = "undefined" !== typeof p[b] ? p[b] : 0,
                                    B = r + y,
                                    r = q + y,
                                    a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.y2 - B) && (B = e.y2),
                                    p[b] = y + (B - r);
                                b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, t, r, C, B, b, 0, null, x && 0 <= u[h].y, 0 > u[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                ...
                                else if (n = a.axisY.convertValueToPixel(u[h].y),
                                0 <= u[h].y) {
                                    var y = f[b] ? f[b] : 0;
                                    B = q + y;
                                    n += y;
                                ...
                                b = P(b);
                                s && ca(this._eventManager.ghostCtx, B, t, n, C, b, 0, null, !1, !1, !1, !1);
                                (u[h].indexLabel || m.indexLabel || u[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        for (h = 0; h < u.length; h++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                                    ...
                                    A[b] = t + (A[b] ? A[b] : 0),
                                    n = p[b] ? p[b] : q,
                                    p[b] = t = a.axisY.convertValueToPixel(A[b]);
                                else if (n = a.axisY.convertValueToPixel(t),
                                0 <= u[h].y) {
                                    var y = f[b] ? f[b] : 0;
                                    t = q + y;
                                    n += y;
                                    ...
                                    t = n - y,
                                    n = q - y,
                                    a.dataSeriesIndexes.length - 1 === z && 1 >= Math.abs(e.x1 - t) && (t = e.x1),
                                    p[b] = y + (n - t);
                                b = u[h].color ? u[h].color : m._colorSet[h % m._colorSet.length];
        ...
        m.prototype.renderArea = function(a) {
            ...
            function b() {
                ...
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = E : 0 > a.axisY.viewportMaximum ? C = l.y1 : 0 < a.axisY.viewportMinimum && (C = E),
                f.lineTo(m, C),
                f.lineTo(B.x, C),
                f.closePath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    A = [];
                    d = !0;
                    var k = 0, m, u, t, E = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), C, B = null;
                    if (0 < z.length) {
                        ...
                        for (var ja = !0; k < z.length; k++)
                            if (t = z[k].x.getTime ? z[k].x.getTime() : z[k].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof z[k].y)
                                    ...
                                    k < z.length - 1 && (w !== (z[k].lineColor || v) || c !== (z[k].lineDashType || g.lineDashType)) && (b(),
                                    w = z[k].lineColor || v,
                                    f.strokeStyle = w,
                                    f.setLineDash && (z[k].lineDashType ? (c = z[k].lineDashType,
                                    ...
                                    0 !== z[k].markerSize && (0 < z[k].markerSize || 0 < g.markerSize) && (t = g.getMarkerProperties(k, m, u, f),
                                    A.push(t),
                                    Z = P(Z),
                                    s && A.push({
                                        x: m,
        ...
        m.prototype.renderSplineArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    p = P(p);
                    e.fillStyle = p;
                    var p = [], q = 0, g, z, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null, t = [];
                    if (0 < r.length) {
                        var E = n._colorSet[q % n._colorSet.length]
                          , C = n.lineColor = n.options.lineColor || E
                          , B = C;
                        b.fillStyle = E;
                        b.strokeStyle = C;
                        ...
                        var y = "solid";
                        if (b.setLineDash) {
                            var w = N(n.nullDataLineDashType, n.lineThickness)
                              , y = n.lineDashType
                              , D = N(y, n.lineThickness);
                            b.setLineDash(D)
                        }
                        for (z = !1; q < r.length; q++)
                            if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !z)))
                                if ("number" !== typeof r[q].y)
                                    0 < q && !z && (n.connectNullData ? b.setLineDash && (0 < t.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = w,
                                    y = n.nullDataLineDashType) : (d(),
                                    t = [])),
                                    z = !0;
                                else {
                                    ...
                                    q < r.length - 1 && (B !== (r[q].lineColor || C) || y !== (r[q].lineDashType || n.lineDashType)) && (B = r[q].lineColor || C,
                                    t[t.length - 1].newStrokeStyle = B,
                                    b.setLineDash && (r[q].lineDashType ? (y = r[q].lineDashType,
                                    t[t.length - 1].newLineDashArray = N(y, n.lineThickness)) : (y = n.lineDashType,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < z.length) {
                        ...
                        for (; k < z.length; k++)
                            if (t = z[k].x.getTime ? z[k].x.getTime() : z[k].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Z = u;
                                "number" !== typeof z[k].y ? (g.connectNullData || (c || d) || b(),
                                c = !0) : (m = a.axisX.convertValueToPixel(t),
                                u = a.axisY.convertValueToPixel(z[k].y),
                                ...
                                k < z.length - 1 && (w !== (z[k].lineColor || v) || S !== (z[k].lineDashType || g.lineDashType)) && (b(),
                                w = z[k].lineColor || v,
                                f.strokeStyle = w,
                                f.setLineDash && (z[k].lineDashType ? (S = z[k].lineDashType,
                                ...
                                0 !== z[k].markerSize && (0 < z[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, u, f),
                                A.push(Z),
                                t = P(t),
                                s && A.push({
                                    x: m,
        ...
        m.prototype.renderStackedArea = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = s ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], l = this.plotArea, A = [], h = [], n = [], r = [], q = 0, g, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), t = this._eventManager.ghostCtx, u, x, E;
                s && t.beginPath();
                b.save();
                s && t.save();
                b.beginPath();
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q]
                              , fa = null
                              , fa = 0 <= y.dataPointIndexes[f] ? v[y.dataPointIndexes[f]] : {
                                x: f,
                                y: null
                            };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !Z)))
                                if ("number" !== typeof fa.y)
                                    y.connectNullData || (Z || x) || d(),
                                    Z = !0;
                                else {
                                    ...
                                    A[f] = m - k;
                                    x || Z ? (!x && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || E === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (x = h.pop(),
                                    E = h[h.length - 1],
                                    d(),
                                    b.moveTo(u.x, u.y),
                                    h.push(E),
                                    h.push(x),
                                    E = y.nullDataLineDashType,
                                    b.setLineDash(R)),
                                    b.lineTo(g, k),
                                    s && t.lineTo(g, k)) : (b.beginPath(),
                                    b.moveTo(g, k),
                                    s && (t.beginPath(),
                                    t.moveTo(g, k))),
                                    Z = x = !1) : (b.lineTo(g, k),
                                    ...
                                    q < v.length - 1 && (S !== (v[q].lineColor || w) || E !== (v[q].lineDashType || y.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, k),
                                    h.push({
                                        x: g,
                                    ...
                                    S = v[q].lineColor || w,
                                    b.strokeStyle = S,
                                    b.setLineDash && (v[q].lineDashType ? (E = v[q].lineDashType,
                                    b.setLineDash(N(E, y.lineThickness))) : (E = y.lineDashType,
                                    b.setLineDash(D))));
                                    ...
                                    0 <= y.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < y.markerSize) && (ma = y.getMarkerProperties(y.dataPointIndexes[f], g, k, b),
                                    p.push(ma),
                                    f = P(F),
                                    s && p.push({
                                        x: g,
        ...
        m.prototype.renderStackedArea100 = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = s ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = [], k = [], h = [], n = [], r = [], q = 0, g, z, m, t, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), E = this._eventManager.ghostCtx;
                b.save();
                s && E.save();
                b.beginPath();
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q]
                              , fa = null
                              , fa = 0 <= y.dataPointIndexes[f] ? w[y.dataPointIndexes[f]] : {
                                x: f,
                                y: null
                            };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !Z)))
                                if ("number" !== typeof fa.y)
                                    y.connectNullData || (Z || t) || d(),
                                    Z = !0;
                                else {
                                    var ma;
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        z = a.axisY.convertValueToPixel(ma),
                                        z -= ba;
                                    h.push({
                                        x: g,
                                        y: x - ba
                                    ...
                                    k[f] = x - z;
                                    t || Z ? (!t && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || u === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (t = h.pop(),
                                    u = h[h.length - 1],
                                    d(),
                                    b.moveTo(m.x, m.y),
                                    h.push(u),
                                    h.push(t),
                                    u = y.nullDataLineDashType,
                                    b.setLineDash(R)),
                                    b.lineTo(g, z),
                                    s && E.lineTo(g, z)) : (b.beginPath(),
                                    b.moveTo(g, z),
                                    s && (E.beginPath(),
                                    E.moveTo(g, z))),
                                    Z = t = !1) : (b.lineTo(g, z),
                                    ...
                                    q < w.length - 1 && (S !== (w[q].lineColor || D) || u !== (w[q].lineDashType || y.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, z),
                                    h.push({
                                        x: g,
                                    ...
                                    S = w[q].lineColor || D,
                                    b.strokeStyle = S,
                                    b.setLineDash && (w[q].lineDashType ? (u = w[q].lineDashType,
                                    b.setLineDash(N(u, y.lineThickness))) : (u = y.lineDashType,
                                    b.setLineDash(F))));
                                    if (0 <= y.dataPointIndexes[f]) {
                                    ...
                                    0 <= y.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < y.markerSize) && (ba = y.getMarkerProperties(q, g, z, b),
                                    l.push(ba),
                                    f = P(G),
                                    s && l.push({
                                        x: g,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, g = 0, e = 0; e < q.length; e++)
                        ...
                        g > l && (l = g),
                        g < k && (k = g));
                for (var z = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, z), h = 0; h < a.dataSeriesIndexes.length; h++)
                    ...
                    if (0 < n.length) {
                        ...
                        for (var r = 0, q = 0, e = 0; e < n.length; e++)
                            ...
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                r = P(r),
                                s && X.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness),
        ...
        m.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = 0, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, z = a.axisX.dataInfo.minDiff;
                isFinite(z) || (z = 0.3 * Math.abs(a.axisX.range));
                z = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(z) / Math.log(a.axisX.range) : Math.abs(z) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var v = a.dataSeriesIndexes[m]
                      ...
                      , x = u.dataPoints;
                    if (0 < x.length)
                        for (var E = 5 < z && u.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !t(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
                                ...
                                var C = k - z / 2 << 0
                                  ...
                                  , e = x[l].color ? x[l].color : u._colorSet[0]
                                  , y = Math.round(Math.max(1, 0.15 * z))
                                  , w = 0 === y % 2 ? 0 : 0.5
                                  , D = u.dataPointIds[l];
                                ...
                                "candlestick" === u.type ? (c.moveTo(k - w, n),
                                c.lineTo(k - w, Math.min(h, q)),
                                c.stroke(),
                                c.moveTo(k - w, Math.max(h, q)),
                                c.lineTo(k - w, r),
                                c.stroke(),
                                ca(c, C, Math.min(h, q), B, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? u.risingColor : f, y, e, E, E, !1, !1, u.fillOpacity),
                                s && (e = P(D),
                                b.strokeStyle = e,
                                b.moveTo(k - w, n),
                                ...
                                b.lineTo(k - w, r),
                                b.stroke(),
                                ca(b, C, Math.min(h, q), B, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(k - w, n),
                                c.lineTo(k - w, r),
                                c.stroke(),
                                c.beginPath(),
                                c.moveTo(k, h),
        ...
        m.prototype.renderBoxAndWhisker = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              ...
              , b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, p = 0, l, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, z = a.axisX.dataInfo.minDiff;
                isFinite(z) || (z = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var u = a.dataSeriesIndexes[v]
                      ...
                      , E = x.dataPoints;
                    if (0 < E.length)
                        for (var C = 5 < z && x.bevelEnabled ? !0 : !1, p = 0; p < E.length; p++)
                            if (E[p].getTime ? g = E[p].x.getTime() : g = E[p].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !t(E[p].y) && E[p].y.length && "number" === typeof E[p].y[0] && "number" === typeof E[p].y[1] && "number" === typeof E[p].y[2] && "number" === typeof E[p].y[3] && "number" === typeof E[p].y[4] && 5 === E[p].y.length) {
                                ...
                                var B = l - z / 2 << 0
                                  , y = l + z / 2 << 0
                                  , e = E[p].color ? E[p].color : x._colorSet[0]
                                  , w = Math.round(Math.max(1, 0.15 * z))
                                  , D = 0 === w % 2 ? 0 : 0.5
                                  ...
                                  , Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= z ? z : Z : "string" === typeof Z ? parseInt(Z) * z / 100 > z ? z : parseInt(Z) * z / 100 : z
                                  ...
                                  , M = "number" === typeof E[p].lineThickness ? E[p].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : w
                                  , Q = E[p].lineDashType ? E[p].lineDashType : x.lineDashType
                                  , K = 1 === Math.round(M) % 2 ? 0.5 : 0
                                  , V = x.upperBoxColor
                                  , wa = x.lowerBoxColor
                                  , ra = t(x.options.fillOpacity) ? 1 : x.fillOpacity
                                  , O = x.dataPointIds[p];
                                ...
                                c.lineWidth = w;
                                c.strokeStyle = e;
                                c.rect(B - D, Math.min(h, n) - D, y - B + 2 * D, Math.max(h, n) - Math.min(h, n) + 2 * D);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(),
                                c.globalAlpha = 1,
                                ...
                                c.save();
                                0 < R && (c.beginPath(),
                                c.setLineDash && c.setLineDash(N(F, R)),
                                c.strokeStyle = S,
                                c.lineWidth = R,
                                ...
                                b.lineTo(l - D - G, n),
                                b.stroke()),
                                ca(b, B, Math.max(h, n), y, Math.min(h, n), e, 0, null, !1, !1, !1, !1),
                                0 < R && (b.beginPath(),
                                b.lineWidth = R,
                                b.moveTo(l + Z / 2, r - fa),
                                b.lineTo(l - Z / 2, r - fa),
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length)
                        for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            ...
                            !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !t(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
        ...
        m.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (y ? v : 1))) << 0 : 0.03 * this.width);
                    ...
                    u > l && (u = l);
                    if (0 < B.length)
                        for (var F = C._colorSet, l = 0; l < B.length; l++) {
                            var e = C.lineColor = C.options.color ? C.options.color : F[0]
                              , S = {
                                ...
                                trimLength: t(B[l].whiskerLength) ? t(C.options.whiskerLength) ? 50 : 0 : 0
                            };
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !t(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                ...
                                b ? r = ja : g = ja;
                                b ? (q = a.axisX.reversed ? h + (y ? v : 1) * u / 2 - (y ? D - 1 : 0) * u << 0 : h - (y ? v : 1) * u / 2 + (y ? D - 1 : 0) * u << 0,
                                g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? k + (y ? v : 1) * u / 2 - (y ? D - 1 : 0) * u << 0 : k - (y ? v : 1) * u / 2 + (y ? D - 1 : 0) * u << 0,
                                r = a.axisX.reversed ? n - u << 0 : n + u << 0);
                                !b && q > g && (ja = q,
                                q = g,
                                g = ja);
                                b && n > r && (ja = n,
                                ...
                                w(c, Math.min(n, r), Math.min(q, g), Math.max(r, n), Math.max(g, q), e, S, R, b);
                                s && w(this._eventManager.ghostCtx, n, q, r, g, e, S, R, b);
                                if (B[l].indexLabel || C.indexLabel || B[l].indexLabelFormatter || C.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: B[l],
                                        dataSeries: C,
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            ...
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !t(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                                ...
                                b = P(b);
                                s && ca(this._eventManager.ghostCtx, p, k, l, v, b, 0, null, !1, !1, !1, !1);
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var S = !0; g < r.length; g++)
                            if (u = r[g].x.getTime ? r[g].x.getTime() : r[g].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                                if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                                    ...
                                    q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || y === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D,
                                    y = n.nullDataLineDashType,
                                    b.setLineDash(w)),
                                    b.lineTo(m, t),
                                    s && e.lineTo(m, t),
                                    k.push({
                                    ...
                                    g < r.length - 1 && (B !== (r[g].lineColor || C) || y !== (r[g].lineDashType || n.lineDashType)) && (d(),
                                    B = r[g].lineColor || C,
                                    k[k.length - 1].newStrokeStyle = B,
                                    b.strokeStyle = B,
                                    b.setLineDash && (r[g].lineDashType ? (y = r[g].lineDashType,
                                    k[k.length - 1].newLineDashArray = N(y, n.lineThickness),
                                    b.setLineDash(k[k.length - 1].newLineDashArray)) : (y = n.lineDashType,
                                    ...
                                    if (0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < n.markerSize)) {
                                        ...
                                        R = n.getMarkerProperties(g, m, t, b);
                                        f.push(R);
                                        F = P(u);
                                        s && f.push({
                                            x: m,
        ...
        m.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    if (0 < h.lineThickness) {
                        ...
                        g++) {
                            if (t[g].newStrokeStyle || t[g].newLineDashArray)
                                b.stroke(),
                                b.beginPath(),
                                b.moveTo(d[f].x, d[f].y),
                                t[g].newStrokeStyle && (b.strokeStyle = t[g].newStrokeStyle),
                                t[g].newLineDashArray && b.setLineDash(t[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        d = v(t, 2);
                        b.moveTo(d[0].x, d[0].y);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var f = [], r = 0, q, g, m, t = [], w = [];
                    if (0 < n.length) {
                        var u = h._colorSet[r % h._colorSet.length]
                        ...
                        var C = "solid", B;
                        if (b.setLineDash) {
                            var y = N(h.nullDataLineDashType, h.lineThickness)
                              , C = h.lineDashType;
                        ...
                        for (g = !1; r < n.length; r++)
                            ...
                            !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" === typeof n[r].y[1]) {
                                    ...
                                    r < n.length - 1 && (E !== (n[r].lineColor || x) || C !== (n[r].lineDashType || h.lineDashType)) && (E = n[r].lineColor || x,
                                    t[t.length - 1].newStrokeStyle = E,
                                    b.setLineDash && (n[r].lineDashType ? (C = n[r].lineDashType,
                                    t[t.length - 1].newLineDashArray = N(C, h.lineThickness)) : (C = h.lineDashType,
                                    t[t.length - 1].newLineDashArray = B)));
                                    ...
                                    0 < r && !g && (h.connectNullData ? b.setLineDash && (0 < t.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = y,
                                    C = h.nullDataLineDashType) : (d(B, x),
                                    t = [],
                                    w = [])),
                                    g = !0;
                        d(B, x);
        ...
        m.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var E = 5 < q && t.bevelEnabled ? !0 : !1, C = !1, B = null, y = null, p = 0; p < v.length; p++)
                            if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x,
                            "number" !== typeof v[p].y) {
                                if (0 < p && !C && t.connectNullData)
                                    var w = t.options.nullDataLineDashType || !v[p - 1].lineDashType ? t.nullDataLineDashType : v[p - 1].lineDashType;
                                C = !0
                            } else {
                                ...
                                0 < p && B && (!C || t.connectNullData) && (C && c.setLineDash && c.setLineDash(N(w, u)),
                                c.beginPath(),
                                c.moveTo(B, y - x),
                                c.lineTo(S, R - x),
                                0 < u && c.stroke(),
        ...
        m.prototype.renderPie = function(a) {
            function d() {
                if (h && n) {
                    ...
                    for (e = 0; e < n.length; e++)
                        l = g[(c + e) % n.length],
                        1 < a && (l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !r ? (l.hemisphere = "right",
                        f++) : (l.hemisphere = "left",
                        r = !0));
                    r = !1;
                    for (e = 0; e < n.length; e++)
                        l = g[(d + e) % n.length],
                        1 < b && (l.midAngle > 3 * Math.PI / 2 - u && l.midAngle < 3 * Math.PI / 2 + u) && (p <= b / 2 && !r ? (l.hemisphere = "left",
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * y * Math.cos(g[b].midAngle)
                          ...
                          , l = !1;
                        if (n[b].exploded) {
                            if (1E-9 < Math.abs(g[b].center.x - (E.x + e)) || 1E-9 < Math.abs(g[b].center.y - (E.y + f)))
                                g[b].center.x = E.x + e * a,
                                g[b].center.y = E.y + f * a,
                                l = !0
                        } else if (0 < Math.abs(g[b].center.x - E.x) || 0 < Math.abs(g[b].center.y - E.y))
                ...
                for (b = b = 0; b < n.length; b++)
                    ...
                    "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + y * Math.cos(c.midAngle),
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    c = 0,
                    c = "right" === k.hemisphere ? E.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - E.y, 2)) : E.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - E.y, 2)),
                    k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (l = (a - 1 + g.length) % g.length,
                    l = g[l],
                    a = g[(a + 1 + g.length) % g.length],
                    "left" === k.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u && (l = (a - 1 + g.length) % g.length,
                    l = g[l],
                    a = g[(a + 1 + g.length) % g.length],
                    ...
                    k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - E.y, k.indexLabelTextBlock.x - E.x))
                }
                return h
            }
            function p() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && y - d <= D)
                        l = !1;
                    l && (y -= d);
                    d = 0;
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (var t, u, a = 0; a < n.length; a++) {
                            ...
                            if (null !== B) {
                                ...
                                var w = 0
                                  , w = b(t, u) - m;
                                if (0 > w) {
                                    for (var C = u = 0, J = 0; J < n.length; J++)
                                        J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? u++ : C++);
                                    u = w / (u + C || 1) * C;
                                    var C = -1 * (w - u)
                                      , I = J = 0;
                                    "right" === p.hemisphere ? (J = f(a, u),
                                    C = -1 * (w - J),
                                    I = f(B, C),
                                    +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +u.toFixed(x) && f(a, -(C - I))) : (J = f(B, u),
                                    C = -1 * (w - J),
                                    I = f(a, C),
                                    +I.toFixed(x) < +C.toFixed(x) && +J.toFixed(x) <= +u.toFixed(x) && f(B, -(C - I)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < n.length; a++)
                            ...
                            B = E.x + s * Math.cos(p.midAngle),
                            u = E.y + s * Math.sin(p.midAngle),
                            p.indexLabelTextBlock.x = B,
                            p.indexLabelTextBlock.y = u;
                    for (a = 0; a < n.length; a++)
                        if (p = g[a],
                        ...
                        0 !== B.height && 0 !== B.width)
                            ...
                            0 < B && (!l && p.indexLabelText && (u = "right" === p.hemisphere ? q.x2 - p.indexLabelTextBlock.x : p.indexLabelTextBlock.x - q.x1,
                            0.3 * p.indexLabelTextBlock.maxWidth > u ? p.indexLabelText = "" : p.indexLabelTextBlock.maxWidth = 0.85 * u,
                            0.3 * p.indexLabelTextBlock.maxWidth < u && (p.indexLabelTextBlock.x -= "right" === p.hemisphere ? 2 : -2)),
                            Math.abs(p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - E.y) < y || Math.abs(p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 - E.y) < y) && (B /= Math.abs(Math.cos(p.indexLabelAngle)),
                            9 < B && (B *= 0.3),
                            B > d && (d = B)),
                            B = B = 0,
                            ...
                            0 < B && (!l && p.indexLabelText && (u = 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === f(a, B * u) && f(a, 2 * u)),
                            Math.abs(p.indexLabelTextBlock.x - E.x) < y && (B /= Math.abs(Math.sin(p.indexLabelAngle)),
                            9 < B && (B *= 0.3),
                            B > d && (d = B)));
                            ...
                            t.indexLabelText) {
                                ...
                                if (null !== p) {
                                    ...
                                    if (k = 0 > w) {
                                        ...
                                        k = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < l.indexLabelTextBlock.x - r || k > z + r || q > A + r || m < u - r ? !1 : !0
                                    }
                                    k ? (0 > a && (a = h),
                                    p !== a && (c = p,
                                    d += -w),
            ...
            var k = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, r = 10, q = this.plotArea, g = h.dataPointEOs, m = 2, s, v = 1.3, u = 20 / 180 * Math.PI, x = 6, E = {
                    x: (q.x2 + q.x1) / 2,
                    y: (q.y2 + q.y1) / 2
                }, w = 0;
                a = !1;
                ...
                if (0 !== w) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        k.isAnimating || !t(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function b() {
                if (u && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, z = [], A = [], v = {
                        percent: null,
                        total: null
                    }, B = null, y = 0; y < x.length; y++)
                        m = O[y],
                        m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2,
                        m = g(m).x2 + 1,
                        z[y] = M - m - V;
                    m = 0.5 * V;
                    for (var y = 0, E = x.length - 1; y < x.length || 0 <= E; y++,
                    E--) {
                        ...
                        "inside" === u.indexLabelPlacement && (z[y] = y !== ca ? u.reversed ? O[y].x2 - O[y].x1 : O[y].x3 - O[y].x4 : O[y].x3 - O[y].x6,
                        20 > z[y] && (z[y] = y !== ca ? u.reversed ? O[y].x3 - O[y].x4 : O[y].x2 - O[y].x1 : O[y].x2 - O[y].x1,
                        z[y] /= 2));
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, h = M - $ - V / 2, h = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > h ? h : u.indexLabelMaxWidth : h, l = H.length - 1; 0 <= l; l--) {
                    g = x[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        ...
                        u.reversed ? (H[l].textBlock.y + H[l].height > T + C && (H[l].textBlock.y = T + C - H[l].height),
                        H[l].textBlock.y < ra - C && (H[l].textBlock.y = ra - C)) : (H[l].textBlock.y < T - C && (H[l].textBlock.y = T - C),
                        H[l].textBlock.y + H[l].height > ra + C && (H[l].textBlock.y = ra + C - H[l].height))
            }
            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++)
                        ...
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        b = u.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                        H[e].textBlock.x = b + V,
                        H[e].textBlock.y = c - H[e].height / 2,
                        u.reversed ? (H[e].textBlock.y + H[e].height > T + C && (H[e].textBlock.y = T + C - H[e].height),
                        H[e].textBlock.y < ra - C && (H[e].textBlock.y = ra - C)) : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C),
                        H[e].textBlock.y + H[e].height > ra + C && (H[e].textBlock.y = ra + C - H[e].height)));
                else
            ...
            function l(a, b) {
                return (b < O.length ? H[b].textBlock.y : u.reversed ? T + C : ra + C) - (0 > a ? u.reversed ? ra - C : T - C : H[a].textBlock.y + H[a].height + da)
            }
            function k(a, b, c) {
                var d, e, g, l = [], p = C, r = [];
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    v(d);
                    I && ("inside" !== u.indexLabelPlacement ? n(d) : f(),
                    m(d));
                    1 <= c && (ha = !1)
            ...
            var w = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, E = this.plotArea, C = 0.025 * E.width, B = 0.01 * E.width, y = 0, D = E.height - 2 * C, F = Math.min(E.width - 2 * B, 2.8 * E.height), I = !1, R = 0; R < x.length; R++)
                    ...
                    !I && "function" === typeof u.indexLabelFormatter || "function" === typeof x[R].indexLabelFormatter)
                        I = !0;
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    a = 75 * F / 100;
                    var V = 30 * (M - a) / 100;
                    "funnel" === u.type ? (ba = t(u.options.neckHeight) ? 0.35 * D : u.neckHeight,
                    G = t(u.options.neckWidth) ? 0.25 * a : u.neckWidth,
                    ...
                    var B = R + a / 2
                      ...
                      , K = B - G / 2
                      , X = B + G / 2
                      , wa = u.reversed ? Z + ba : Q - ba
                      , ra = u.reversed ? Z : Q;
                    a = [];
                    var B = [], O = [], F = [], U = Z, ca, aa = (wa - T) / (K - W), ea = -aa, R = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== R) {
                        if (u.reversed)
                            for (F.push(U),
                            G = R.length - 1; 0 < G; G--)
                        ...
                        if (u.reversed)
                            for (G = 0; G < R.length; G++)
                                F[G] < wa ? (a.push(K),
                                B.push(X),
                                ca = G) : (a.push((F[G] - T + aa * W) / aa),
                                B.push((F[G] - T + ea * $) / ea));
                        else
                            for (G = 0; G < R.length; G++)
                                F[G] < wa ? (a.push((F[G] - T + aa * W) / aa),
                                B.push((F[G] - T + ea * $) / ea),
                                ca = G) : (a.push(K),
                                B.push(X));
                        for (G = 0; G < R.length - 1; G++)
                            U = u.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : u._colorSet[(x.length - 1 - G) % u._colorSet.length] : x[G].color ? x[G].color : u._colorSet[G % u._colorSet.length],
                            G === ca ? O.push({
                                x1: a[G],
                                y1: F[G],
                                x2: B[G],
                        ...
                        for (G = 0; G < x.length; G++)
                            x[G].exploded && (R = !0,
                            u.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
                        ...
                        for (G = 0; G < O.length; G++)
                            y = O[G],
                            pa(P, y, u.fillOpacity),
                            ga.push(y.y1);
                        v(P);
                        I && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled || n(P),
                        w.animationEnabled || m());
                        if (!I)
                            for (G = 0; G < x.length; G++)
                                y = u.dataPointIds[G],
                                a = {
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !w.isAnimating && (t(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex,
                            0 <= b)) {
                                a = b;
                ...
                if (r.dataPoints && r.dataPoints.length)
                    if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                        var q = r.legendMarkerType = r.legendMarkerType ? r.legendMarkerType : "line" !== r.type && "stepLine" !== r.type && "spline" !== r.type && "scatter" !== r.type && "bubble" !== r.type || !r.markerType ? "error" === r.type && r._linkedSeries ? r._linkedSeries.legendMarkerType ? r._linkedSeries.legendMarkerType : I.getDefaultLegendMarker(r._linkedSeries.type) : I.getDefaultLegendMarker(r.type) : r.markerType
                          ...
                          , u = r.legendMarkerBorderThickness ? r.legendMarkerBorderThickness : r.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0;
                        ...
                        for (var x = 0; x < r.dataPoints.length; x++) {
                            var w = r.dataPoints[x]
                              , q = w.legendMarkerType ? w.legendMarkerType : r.legendMarkerType ? r.legendMarkerType : I.getDefaultLegendMarker(r.type)
                              ...
                              , v = w.legendMarkerBorderColor ? w.legendMarkerBorderColor : r.legendMarkerBorderColor ? r.legendMarkerBorderColor : w.markerBorderColor ? w.markerBorderColor : r.markerBorderColor
                              ...
                              , g = this.chart.replaceKeywordsWithValue(g, w, r, x)
                              , q = {
                                markerType: q,
                                markerColor: m,
                                text: g,
                            ...
                            (w.showInLegend || r.showInLegend && !1 !== w.showInLegend) && k.push(q)
                        }
            }
                ...
                for (n = 0; n < k.length; n++) {
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                            if (!r || r.width + Math.round(q.textBlock.width + s + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                                r = {
                                    items: [],
                                    width: 0
                                },
                        ...
                        q.textBlock.y = 0;
                        r.width += Math.round(q.textBlock.width + s + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0));
                        r.items.push(q);
        ...
        F.prototype.render = function() {
            ...
            for (var l = 0, k = 0; k < p.length; k++) {
                for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    ...
                    this.ghostCtx.fillRect(t, q.textBlock.y - this.lineHeight / 2, q.textBlock.x + q.textBlock.width - t, q.textBlock.height);
            ...
            for (; ; ) {
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        ...
                        case "doughnut":
                            t = q.center;
                            s = "doughnut" === this.type ? q.percentInnerRadius * q.radius : 0;
                            m = Math.sqrt(Math.pow(t.x - a, 2) + Math.pow(t.y - d, 2));
                            m < q.radius && m > s && (m = Math.atan2(d - t.y, a - t.x),
                            0 > m && (m += 2 * Math.PI),
                            m = Number(((180 * (m / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            t = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            s = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            0 === s && 1 < q.endAngle && (s = 360),
                            t >= s && 0 !== g.y && (s += 360,
                            m < t && (m += 360)),
                            m > t && m < s && (b.push({
                                dataPoint: g,
        ...
        D.prototype.createLabels = function() {
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (t(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
                90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
                    ...
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (t(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    ...
                                    !t(this.options.labelWrap))
                                        this.labelWrap ? t(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n),
                                        this.sessionVariables.labelWrap = this.labelWrap,
                                        d && m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                        this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : t(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxHeight = p,
                                        this.sessionVariables.labelMaxWidth = f,
                                        ...
                                        if (t(this.options.labelWrap))
                                            if (!t(this.options.labelMaxWidth))
                                                ...
                                                q < f)
                                                    ...
                                                    t(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    ...
                                                    t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = n,
                                                    this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (t(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    ...
                                                    for (this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                    ...
                                    t(this.options.labelWrap)) ? t(this.options.labelWrap) && (this.labelWrap && !t(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                    ...
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : n) : (t(this.options.labelMaxWidth),
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : n,
                                    this.sessionVariables.labelWrap = this.labelWrap),
                                    this.sessionVariables.labelMaxHeight = p)
                            }
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            a = this._labels[c].textBlock,
                            a.maxWidth = this.labelMaxWidth = t(this.options.labelMaxWidth) ? t(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
                            a.fontSize = this.labelFontSize = t(this.options.labelFontSize) ? t(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize,
                            a.angle = this.labelAngle = t(this.options.labelAngle) ? t(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle,
                            a.wrap = this.labelWrap = t(this.options.labelWrap) ? t(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap,
                            a.maxHeight = t(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = p : this.sessionVariables.labelMaxHeight,
                            a.measureText();
                else if ("left" === this._position || "right" === this._position)
                    if (f = t(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                    p = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        this.sessionVariables.labelFontSize = this.labelFontSize;
                        this.sessionVariables.labelMaxWidth = f;
                        this.sessionVariables.labelMaxHeight = p;
                        this.sessionVariables.labelAngle = t(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle;
                        this.sessionVariables.labelWrap = this.labelWrap;
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                a = this._labels[c].textBlock;
                                ...
                                Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                                t(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? t(this.options.labelWrap) ? t(this.options.labelWrap) && (t(this.options.labelMaxWidth) ? t(d) || (l = m.height + d.height >> 0,
                                l - 2 * p > q && (q = l - 2 * p,
                                l >= 2 * p && l < 2.4 * p ? (t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * p && l < 2.8 * p ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : l >= 2.8 * p && l < 3.2 * p ? (this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelWrap = !0,
                                t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = t(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l >= 3.2 * p && l < 3.6 * p ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * p && l < 10 * p ? (t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelAngle = t(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l > 10 * p && l < 50 * p && (t(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = t(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelAngle = t(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = p,
                                ...
                                t(this.options.labelWrap)) ? t(this.options.labelWrap) && (this.labelWrap && !t(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth > this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                ...
                                t(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b,
                                this.sessionVariables.labelWrap = this.labelWrap,
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        w = t(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position)
                        w = t(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    ...
                    w = t(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    t(f.labelBackgroundColor) && (t(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = s ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
                a = new ia(this.ctx,{
                    x: 0,
                    y: 0,
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var m = q[g].scaleBreaks._appliedBreaks, s = 0; s < m.length && !(m[s].startValue > q[g].viewportMaximum); s++)
                        m[s].endValue < q[g].viewportMinimum || (t(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s),
                        m[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            for (var v = s = 0, u = 0, x = 0, w = 0, C = 0, B = 0, y, D, F = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++)
            ...
            if ("normal" === e) {
                for (var x = [], w = [], C = [], B = [], M = [], N = [], P = [], Q = []; 4 > s; ) {
                    ...
                    if (c && 0 < c.length)
                        for (C = [],
                        g = O = 0; g < c.length; g++)
                            C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                            O += C[g],
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            ...
                            !a[g] || (!a[g].labelAutoFit || t(y) || t(D) || n.isNavigator || n.stockChart) || (l = 0,
                            0 < a[g].labelAngle ? D + u > k && (l += 0 < a[g].labelAngle ? D + u - k - aa : 0) : 0 > a[g].labelAngle ? y - v < p && y - v < a[g].viewportMinimum && (F = p - (K + a[g].tickLength + C + y - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (D + u > k && (l = D + u / 2 - k - aa),
                            y - v < p && y - v < a[g].viewportMinimum && (F = p - K - a[g].tickLength - C - y + v / 2)),
                            a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < l ? k -= l : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F ? p += F : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (p += F),
                            0 < l && (k -= l))),
                            n.panEnabled ? U = t(n.sessionVariables.axisX.height) ? n.sessionVariables.axisX.height = U : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = U,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                            u = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))),
                            n.panEnabled ? X = t(n.sessionVariables.axisX2.height) ? n.sessionVariables.axisX2.height = X : n.sessionVariables.axisX2.height : n.sessionVariables.axisX2.height = X,
                            l = Math.round(f.y1),
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (C[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0),
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            ...
                            a[g]._labels && 1 < a[g]._labels.length && (y = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            d[g]._labels && 1 < d[g]._labels.length && (y = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                ...
                for (N = []; 4 > s; ) {
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            c[g].labelAutoFit && !t(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ? Math.max(p, x / 2) : p),
                            0 < !d.length && (k = 0 < c[g].labelAngle ? k - w / 2 : 0 === c[g].labelAngle ? k - w / 2 : k)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            ...
                            b[g] && b[g].labelAutoFit && !t(C) && (0 < !a.length && (p = 0 < b[g].labelAngle ? Math.max(p, C) : 0 === b[g].labelAngle ? Math.max(p, C / 2) : p),
                            0 < !d.length && (k -= B / 2)),
                    ...
                    if (b && 0 < b.length)
                        for (y = [],
                        g = V = 0; g < b.length; g++)
                            y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                            V += y[g],
                            $ += b[g].margin;
                    else
                    ...
                    if (n.panEnabled)
                        for (g = 0; g < c.length; g++)
                            r[g] = t(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = r[g] : n.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++)
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            ...
                            h = Math.round(f.y1 + (y[g] + b[g].margin + G)),
        ...
        D.prototype.calculateBreaksInPixels = function() {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                    a[d].endValue < this.conversionParameters.minimum || (t(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
        ...
        D.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, k = !1, l = [], m = [], k = !1, b = 0; b < this.stripLines.length; b++) {
                    ...
                    h._thicknessType === a && ("pixel" === a && (h.value < this.viewportMinimum || h.value > this.viewportMaximum || t(h.value) || isNaN(this.range)) || l.push(h))
                }
                for (b = 0; b < this._stripLineLabels.length; b++)
                    ...
                    !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                        ...
                        if ("outside" === c.stripLine.labelPlacement)
                            ...
                            a.x - c.textBlock.height > this.chart.plotArea.x1 ? t(h.startValue) ? a.x -= c.textBlock.height - c.textBlock.fontSize / 2 : a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3 : (c.textBlock.angle = 90,
                            t(h.startValue) ? a.x += c.textBlock.height - c.textBlock.fontSize / 2 : a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3),
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - c.textBlock.height > this.chart.plotArea.y1 ? t(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : t(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3,
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - +c.textBlock.height > this.chart.plotArea.y1 ? t(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 - 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : t(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3,
        ...
        D.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                s ? (this.maskCanvas = sa(this.chart.width, this.chart.height),
        ...
        D.prototype.renderAxisLine = function() {
            var a = this.chart.ctx, d = s ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f;
            d.save();
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    d.beginPath();
                    if (this.scaleBreaks && !t(this.scaleBreaks.firstBreakIndex))
                        if (t(this.scaleBreaks.lastBreakIndex))
        ...
        D.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if (t(this.options.viewportMinimum) && !t(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum))
                ...
                if (t(this.options.viewportMaximum) && !t(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum))
                ...
                if (this.scaleBreaks)
                    for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
                        if ((!t(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue || !t(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[b].startValue || !t(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue) && (!t(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue || !t(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[b].endValue || !t(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue)) {
        ...
        D.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
                    if ((!t(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue || !t(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[k].startValue || !t(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue) && (!t(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue || !t(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[k].endValue || !t(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue)) {
        ...
        aa.prototype.showAt = function(a) {
            ...
            for (b = 0; b < d.axisX.length; b++)
                ...
                d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !t(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a),
                d.axisX[b].crosshair._updatedValue = a,
                this === d.axisX[b].crosshair && (c = !0));
            for (b = 0; b < d.axisX2.length; b++)
                a = d.axisX2[b]._crosshairValue,
                d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !t(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a),
                d.axisX2[b].crosshair._updatedValue = a,
                this === d.axisX2[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY.length; b++)
                a = d.axisY[b]._crosshairValue,
                d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !t(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a),
                d.axisY[b].crosshair._updatedValue = a,
                this === d.axisY[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY2.length; b++)
                a = d.axisY2[b]._crosshairValue,
                d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !t(a) && d._crosshairY2Value >= d.axisY2[b].viewportMinimum && d._crosshairY2Value <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a),
        ...
        aa.prototype.render = function(a, d, c) {
            ...
            this.labelMaxWidth = t(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth;
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position)
                        s = this.parent.dataSeries[0].axisX.convertPixelToValue({
                            y: d
                        });
                    else if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    for (var w = 0; w < this.parent.dataSeries.length; w++)
                        (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w],
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), u = 0, s = 0; s < n.length; s++)
                            if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                                for (var x = 0; x < n[s].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])),
                                    u < v && (v = u,
                                    w = s);
                            else
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), E = u = 0, s = w = 0; s < n.length; s++)
                            if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                                for (x = 0; x < n[s].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])),
                                    u < v && (v = u,
                                    w = s);
                            else
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = E = u = 0, s = 0; s < n.length; s++)
                            if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                                for (x = 0; x < n[s].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[x])),
                                    u < v && (v = u,
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            for (s = u = 0; s < x.dataPoint.y.length; s++)
                                u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[s])),
                                u < v && (v = u,
                                b = s);
                            ...
                            for (s = w; 0 <= s; s--)
                                ...
                                u < v && (v = u,
                                b = s);
                            l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(E) << 0) + 0.5 : this.parent.convertValueToPixel(E) << 0;
                            h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                ...
                                w = 0; w < this.parent.dataSeries.length; w++)
                                    (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                                        value: x.dataPoint.x
                            ...
                            "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: c ? c : x.dataPoint.x
                            }) : t(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    !t(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (s = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        x: a
                    }));
                    for (w = 0; w < this.parent.dataSeries.length; w++)
                        (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w],
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                        ...
                        s = u = 0; s < n.length; s++)
                            if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                                for (x = 0; x < n[s].dataPoint.y.length; x++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[x])),
                                    u < v && (v = u,
                                    w = s);
                            else
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                        ...
                        for (s = u = 0; s < x.dataPoint.y.length; s++)
                            u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[s])),
                            u < v && (v = u,
                            b = s);
                        ...
                        }) : t(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label,
                        this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (t(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : t(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
                        h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    this._hidden = !1),
                    q.restore(),
                    !t(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    ...
                    if (C) {
                        ...
                        "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : t(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (!t(h) && !t(h.dataPoint) && !t(h.dataPoint.y))
        ...
        $.prototype.highlightObjects = function(a) {
            ...
            if (t(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas)
                this.chart.resetOverlayedCanvas(),
                d.clearRect(0, 0, this.chart.width, this.chart.height),
        ...
        $.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var k = 0; k < this.chart.data.length; k++)
                    c = this.chart.data[k],
                    (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !t(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
                    f.push(b));
            else
                c = this.chart.data[d],
                (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !t(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
